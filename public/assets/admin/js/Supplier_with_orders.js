$(document).ready(function () {
    ...
    $(document).on('input', '#quantity-add', function (e) {
        recaluclate_Add();
      });
    ...
    $(document).on('click', '#AddToBill', function (e) {
        ...
        var quantity_add = $("#quantity-add").val();
        ...
        var token_search = $("#token_search").val();
        var Ajax_add_details = $("#Ajax_add_details").val();
    
            jQuery.ajax({
                url: Ajax_add_details,
                type: 'post',
                dataType: 'json',
                cache: false,
                data: {
  ...
  $(document).on('click', '.editItemDetails', function(e) {
    ...
    var autoserailparent = $("#parent_auto_serial").val();
    var token_search = $("#token_search").val();
    var ajax_search_url = $("#Ajax_load_modal_editdetails").val();
    jQuery.ajax({
        url: ajax_search_url,
        type: 'post',
        dataType: 'html',
...
$(document).on('click', '#EditDetailsItem', function (e) {
      ...
      var parentautoserial = $("#parent_auto_serial").val();
      var token_search = $("#token_search").val();
      var ajax_details = $("#ajax_edit_item_details").val();
      var id = $(this).data("id");
          jQuery.ajax({
              url: ajax_details,
              type: 'post',
              ...
              data: {
                  parentautoserial:parentautoserial,"_token": token_search , item_code_add:item_code_add,
                  uom_id_Add:uom_id_Add,isparentuom:isparentuom,quantity_add:quantity_add,price_add:price_add
                  ,expire_date:expire_date,production_date:production_date,total_add:total_add,type:type,id:id,
              },
              success: function (data) {
